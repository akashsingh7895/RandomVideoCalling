...
import com.avssolutionnnnnnn.avs.randomvideocalling.databinding.ActivityPrivicyPolicyBinding;

public class PrivicyPolicyActivity extends AppCompatActivity implements MaxAdViewAdListener {

    ActivityPrivicyPolicyBinding binding;
    public MaxAdView adView,adView1;
    @Override
